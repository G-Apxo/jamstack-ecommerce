  ...
  return (
    <>
      <div className="w-full">
        <CartLink />
        <Head>
          <title>Sold out - All Categories</title>
          <meta name="description" content={`Sold out - All categories`} />
          <meta property="og:title" content="Sold out - All Categories" key="title" />
        </Head>
        <div className="
          pt-4 sm:pt-10 pb-8
        ">
